                ...
                <div class="col-md-7 col-12 m-auto">
                    <div id="auth-left">
                        <div class="auth-logo mb-3">
                            <a href=""><img src="{{ asset('dist/assets/images/logo/logo.png') }}"
                                    alt="Logo"></a>
                        </div>
                        <h1 class="auth-title mb-0">AES-Algorithm</h1>
                        {{-- <p class="auth-subtitle mb-3" style="margin-left: 25px"></p> --}}

                        @auth
                            <p class="text-secondary font-bold auth-subtitle mb-3">Hello {{ Auth::user()->name }},
                                Welcome Back</p>
                            <a href="{{ url('/home') }}" class="btn btn-outline-primary  font-bold m-auto">To
                                App
                                <i class="fa-solid fa-angle-right"></i>
                            </a>
                        @else
                            <form method="POST" action="{{ route('login') }}" class="col-md-12 mt-5">
                                @csrf
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-6 offset-md-4">
                                        <button type="submit" class="btn btn-primary font-bold col-5 m-2 ">
                                            {{ __('Login') }}
                                        </button>
                                        <a href="{{ route('register') }}"
                                            class="btn btn-outline-primary font-bold col-5 m-2 ">Register</a>
